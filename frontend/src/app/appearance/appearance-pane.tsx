...
// account; `useThemeSeed` (components/settings/theme-seed.ts, run by
// SettingsRouteShell) applies user.theme ONCE when localStorage is empty.

import React from "react";
import { Check } from "lucide-react";

import { HEX_RE } from "@/components/settings/theme-seed";
...
import { PaneSection } from "@/components/settings/shared";
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {THEME_PRESETS.map((t) => {
            ...
            return (
              ...
              >
                {/* Shiori's mock-card swatch: bg page + card block + accent dot */}
                <div
